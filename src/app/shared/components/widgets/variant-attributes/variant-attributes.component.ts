...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, CurrencySymbolPipe, TranslateModule, ButtonComponent],
...
export class VariantAttributesComponent {
  ...
  openSizeChartModal(image: Attachment) {
    const sizeChart = this.modal.open(SizeChartModalComponent, {
      size: "lg",
      centered: true,
    });
